"""Owner consent for subtitle fetching through the host Chrome session."""
...
class HostChromeSessionStore:
    """Stores consent only; no profile path or cookie value is persisted."""
...
__all__ = ["HostChromeSessionStore", "chrome_available"]
