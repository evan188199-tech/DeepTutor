...
def register(app: typer.Typer) -> None:
    ...
    def kb_add_web_source(
        ...
        language: str = typer.Option("auto", "--language", help="Source language: auto, en, zh."),
        paired_url: str = typer.Option("", "--paired-url", help="Counterpart documentation URL."),
        document_version: str = typer.Option(
            "", "--document-version", help="Document/product version."
        ),
        validation_query: list[str] = typer.Option(
            [], "--validation-query", help="Representative query used to validate an index."
        ),
