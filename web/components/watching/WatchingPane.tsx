        ...
        <div className="watching-pane-body flex min-h-0 flex-1 flex-col">
          <div className="watching-media-column">
            ...
            <div
              ...
              hidden={!optionsOpen}
            >
<div className="rounded-lg bg-[var(--background)] text-[var(--foreground)] p-2 mb-3">            <WatchingRemoteLaunch
          ...
          >
            ...
            {tab === "transcript" ? (
              material.transcript.status !== "ready" ? (
                ...
                <>
                  <div className="watching-mark-actions mb-3 flex flex-wrap gap-2">
                    <button
                      type="button"
                      onClick={askHere}
                      disabled={!cue}
                      className="watching-transcript-ask rounded-lg bg-[var(--primary)] px-3 py-2 text-sm text-[var(--primary-foreground)] disabled:opacity-50"
                    >
                      {t("Explain here")}
                    </button>
                    <button
